...
const {domain, xyOpen, jsv, api, v, ecode, dataType, jsonpIncPrefix, ttid, type} = config.xy;
...
const getData = (args) => {
    return new Promise(function (resolve, reject) {
        ...
        let url = `${domain}${xyOpen}?jsv=${jsv}&appKey=${a}&t=${l}&sign=${sign}&api=${api}&v=${v}&ecode=${ecode}&dataType=${dataType}&jsonpIncPrefix=${jsonpIncPrefix}&ttid=${ttid}&type=${type}&callback=${callback}&data=${urlencode(args)}`;
