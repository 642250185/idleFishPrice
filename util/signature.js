...
const getSign = async () => {
    try {
        ...
        const l = "1535772011111";
        const a = "12574478";
        const data = "{\"parentNavPath\":\"catId4:126862528\",\"deep\":2,\"bizCode\":\"3C\"}";
        return await s(token+"&"+l+"&"+a+"&"+data);
    } catch (e) {
        console.error(e);
        return "";
    }
