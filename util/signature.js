...
// const data = '{"spuId":"10287","quoteId":113931264,"questionnaire":[{"id":20037,"name":"型号","questionType":"SINGLECHOISE","required":true,"answers":[{"id":741,"name":"A1865","type":"TEXT","excludeIds":[]}]},{"id":20002,"name":"购买渠道","questionType":"SINGLECHOISE","required":true,"answers":[{"id":6,"name":"大陆国行","type":"TEXT","excludeIds":[]}]},{"id":20001,"name":"内存容量","questionType":"SINGLECHOISE","required":true,"answers":[{"id":4,"name":"64G","type":"TEXT","excludeIds":[]}]},{"id":20004,"name":"机身颜色","questionType":"SINGLECHOISE","required":true,"answers":[{"id":16,"name":"黑/灰色","type":"TEXT","excludeIds":[]}]},{"id":20012,"name":"剩余保修期","questionType":"SINGLECHOISE","required":true,"answers":[{"id":46,"name":"1个月以内或过保","type":"TEXT","excludeIds":[]}]},{"id":20005,"name":"机身外壳","questionType":"SINGLECHOISE","required":true,"answers":[{"id":19,"name":"外壳完好无使用痕迹","type":"TEXT","excludeIds":[]}]},{"id":20006,"name":"屏幕外观","questionType":"SINGLECHOISE","required":true,"answers":[{"id":21,"name":"触屏完美无划痕","type":"TEXT","excludeIds":[]}]},{"id":20035,"name":"屏幕显示","questionType":"SINGLECHOISE","required":true,"answers":[{"id":114,"name":"显示正常","type":"TEXT","excludeIds":[]}]},{"id":20013,"name":"维修拆机史","questionType":"SINGLECHOISE","required":true,"answers":[{"id":47,"name":"无拆无修","type":"TEXT","excludeIds":[]}]},{"id":20003,"name":"开机情况","questionType":"SINGLECHOISE","required":true,"answers":[{"id":10,"name":"正常开机","type":"TEXT","excludeIds":[]}]},{"id":20011,"name":"iCloud账户","questionType":"SINGLECHOISE","required":true,"answers":[{"id":43,"name":"iCloud已注销","type":"TEXT","excludeIds":[]}]}],"dataType":"originaljson"}';
// const dataq = '{"spuId":10287,"quoteId":113931264,"questionnaire":[{"id":20001,"answers":[{"id":4}]},{"id":20037,"answers":[{"id":741}]},{"id":20011,"answers":[{"id":43}]},{"id":20002,"answers":[{"id":6}]},{"id":20004,"answers":[{"id":16}]},{"id":20003,"answers":[{"id":10}]},{"id":20035,"answers":[{"id":114}]},{"id":20012,"answers":[{"id":46}]},{"id":20013,"answers":[{"id":47}]},{"id":20005,"answers":[{"id":19}]},{"id":20006,"answers":[{"id":21}]}]}';
const data = '{"spuId":"10283","sceneType":"3C","channel":"idle","channelData":"{\\"sceneType\\":\\"3C\\",\\"channel\\":\\"undefined\\",\\"spuId\\":\\"10283\\"}","supplierId":"24633099"}';
           //{\"spuId\":\""+pid+"\",\"sceneType\":\"3C\",\"channel\":\"idle\",\"channelData\":\"{\\\"sceneType\\\":\\\"3C\\\",\\\"channel\\\":\\\"undefined\\\",\\\"spuId\\\":\\\""+pid+"\\\"}\"}
// getSign(data);
